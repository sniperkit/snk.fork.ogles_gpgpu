...
void MultiProcInterface::setOutputRenderOrientation(RenderOrientation o) {
    getOutputFilter()->setOutputRenderOrientation(o);
}
RenderOrientation MultiProcInterface::getOutputRenderOrientation() const {
    return getOutputFilter()->getOutputRenderOrientation();
}
...
GLuint MultiProcInterface::getTextureUnit() const {
    return getInputFilter()->getTextureUnit();
}
void MultiProcInterface::setOutputSize(float scaleFactor) {
    getInputFilter()->setOutputSize(scaleFactor);
}
void MultiProcInterface::setOutputSize(int outW, int outH) {
    return getInputFilter()->setOutputSize(outW, outH);
}
int MultiProcInterface::getOutFrameW() const {
    return getOutputFilter()->getOutFrameW();
}
int MultiProcInterface::getOutFrameH() const {
    return getOutputFilter()->getOutFrameH();
}
int MultiProcInterface::getInFrameW() const {
    return getInputFilter()->getInFrameW();
}
int MultiProcInterface::getInFrameH() const {
    return getInputFilter()->getInFrameH();
}
...
GLuint MultiProcInterface::getInputTexId() const {
    return getInputFilter()->getInputTexId();
}
GLuint MultiProcInterface::getOutputTexId() const {
    return getOutputFilter()->getOutputTexId();
}
